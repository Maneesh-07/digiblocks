...
import 'package:digiblocks/views/module/flight_module/componects/filght_card.dart';
import 'package:digiblocks/views/module/flight_module/componects/search_flight_appbar.dart';
                    ...
                    child: P.flight.loading.value
                        ...
                        : Column(
                            ...
                            children: [
                              Space.Y(10),
                              Text(
                                'Showing ${P.flight.flight.length} Direct Flights',
                                style: TextStyle(
                                    fontWeight: FontWeight.normal,
                                    fontSize: 12,
                                    color: textColor.withOpacity(0.3)),
