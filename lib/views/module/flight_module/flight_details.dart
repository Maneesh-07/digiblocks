...
import 'package:digiblocks/views/global_widgets/button.dart';
import 'package:digiblocks/views/global_widgets/custom_appbar.dart';
import 'package:digiblocks/views/global_widgets/space.dart';
...
class _FlightDetailsState extends State<FlightDetails> {
  ...
  LatLng _point1 =
      LatLng(P.dashboard.flyingFrom!.lat!, P.dashboard.flyingFrom!.lng!);
  LatLng _point2 =
      LatLng(P.dashboard.flyingTo!.lat!, P.dashboard.flyingTo!.lng!);
