...
import 'package:digiblocks/views/data/models/flight_model.dart';
import 'package:digiblocks/views/module/dashboard_module/repository.dart';
...
enum Show { SELECT_CITY, SELECT_DATE, HOME, TRAVELLER, FLIGHT_CLASS }

enum Airport { FROM, TO }
...
class DashboardController extends GetxController {
  ...
  filghtInfo() {
    flightModel = FlightModel(
        flyingFrom, flyingTo, travelDate.value, adult.value, flightClass.value);
