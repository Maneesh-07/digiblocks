import 'package:digiblocks/views/core/p.dart';
import 'package:digiblocks/views/data/models/airport_model.dart';
import 'package:digiblocks/views/global_widgets/input.dart';
import 'package:digiblocks/views/module/dashboard_module/componects/airport_item.dart';
import 'package:digiblocks/views/module/dashboard_module/controller.dart';
                ...
                Obx(() => Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            P.dashboard
                                .changeWidgetAirport(widget: Airport.FROM);
                            print('i was clicked');
                          },
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                    ...
                                    fontSize: 12,
                                    color: P.dashboard.airportState.value ==
                                            Airport.FROM
                                        ? textColor
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return GestureDetector(
                                      onTap: () async {
                                        ...
                                        P.dashboard.airport = [];
                                        if (P.dashboard.airportState.value ==
                                            Airport.TO) {
                                          P.dashboard.closeWidgetShowed();
                                          ...
                                          P.dashboard.changeWidgetAirport(
                                              widget: Airport.TO);
